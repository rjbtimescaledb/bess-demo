...
const navItems = [
  ...
  { href: '/operations', label: 'Operations', icon: 'M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z' },
      ...
      <body>
        ...
        <aside className="fixed left-0 top-0 bottom-0 w-60 bg-slate-900 text-white z-50 flex flex-col">
          <div className="px-6 py-5 border-b border-slate-700">
            <div className="flex items-center gap-2">
              ...
              <span className="text-lg font-bold text-white">Dario&apos;s Battery Farm</span>
            </div>
            <p className="text-xs text-slate-400 mt-1">Battery Farm Operations</p>
          </div>
        ...
        <div className="ml-60">
          ...
          <header className="sticky top-0 z-40 bg-white/80 backdrop-blur border-b border-slate-200 px-8 py-3 flex items-center justify-between">
            <h1 className="text-sm font-semibold text-slate-700">Dario&apos;s Battery Farm</h1>
            <div className="flex items-center gap-2">
